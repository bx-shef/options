...
description: Создать компонент Битрикс по канону линейки shef.* — на базе AComponent из shef.options, с готовым жизненным циклом, разбором параметров, проверкой обязательных и сбором ошибок в коллекцию вместо исключений. Вызывать, когда в модуле линейки нужен новый компонент для Битрикс24 или БУС, или когда существующий компонент надо привести к канону.
---
