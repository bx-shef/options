...
description: Страница настроек модуля Битрикс24 на ShOptionsConfig из shef.options — вкладки, типы опций (строка, число, флажок, перечисление, пользователи, отделы, справочники CRM), языковые файлы, чтение сохранённых значений. Брать, когда модулю линейки shef.* нужны настройки в административном разделе или надо добавить опцию на существующую страницу.
---
