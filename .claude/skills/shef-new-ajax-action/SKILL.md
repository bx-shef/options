...
description: Добавить ajax-действие в модуль Битрикс линейки shef.* — в компоненте через AControllerable или отдельным контроллером через AjaxProcessor, с правильными фильтрами прав Actions\Normal и Actions\Free, регистрацией namespace в .settings.php и проверкой прав внутри действия. Вызывать, когда нужен ajax-вызов из админки или публичной части Битрикс24 либо БУС.
---
