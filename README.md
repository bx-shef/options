...
**Вкладка «Документация» пустая.** Не разложилось js-расширение. Проверьте
каталог `/bitrix/js/shef-options/options-markdown/` — здесь имя через дефис, и
это не опечатка: так называются каталоги расширений Битрикса.
