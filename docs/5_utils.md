# [`\Shef\Options\Main\Utils`] Утилиты

|                                    Функция | Описание                                               |
|-------------------------------------------:|:-------------------------------------------------------|
|                 Utils::getCMainApplication | Получения класса `\CAllMain`                           |
|                           Utils::renderTab | Рендерит на странице опций модуля закладку             |
|                        Utils::highlightPhp | Реазизует подсветку синтаксиса php                     |
